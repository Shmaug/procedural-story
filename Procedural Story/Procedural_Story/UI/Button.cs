...
namespace Procedural_Story.UI
{
    class Button : UIElement
    {
        ...
        public Button(UIElement parent, string name, UDim2 position, UDim2 size, string text, string font, Color color1, Color color2, Action action) : base(parent, name, position, size) {
            Text = text;
            this.action = action;
            Font = font;
            TextScale = 1;
        ...
        public override void Draw(SpriteBatch batch) {
            ...
            Color col = Color.Lerp(Color1, Color2, MathHelper.Clamp(hoverTime * 10f, 0, 1));
            Color bgcol = Color.Lerp(bgColor1, bgColor2, MathHelper.Clamp(hoverTime * 10f, 0, 1));
