...
namespace Procedural_Story.Core {
    ...
    abstract class wObject {
        ...
        public Vector3 Position {
            ...
            set {
                RigidBody.Position = new JVector(value.X, value.Y, value.Z);
            }
        }
        public Vector3 Velocity {
            ...
            set {
                RigidBody.LinearVelocity = new JVector(value.X, value.Y, value.Z);
            }
        }
        public Matrix Orientation {
            get {
                JMatrix o = RigidBody.Orientation;
                return new Matrix(
                    o.M11, o.M12, o.M13, 0,
                    o.M21, o.M22, o.M23, 0,
                    o.M31, o.M32, o.M33, 0,
        ...
        public wObject(Vector3 pos, Area a) {
            RigidBody = new RigidBody(new Jitter.Collision.Shapes.BoxShape(JVector.One));
            Position = pos;
            Scale = 1f;
    ...
    class VertexBufferObject : wObject {
        ...
        public override void Draw(GraphicsDevice device) {
            if (RigidBody.EnableDebugDraw)
                if (Vector3.DistanceSquared(Position,Camera.CurrentCamera.Position) < 50 * 50)
                    RigidBody.DebugDraw(area.jDrawer);
    ...
    class BillboardObject : wObject {
        ...
        public override void Draw(GraphicsDevice device) {
            if (VBuffer == null) {
                ...
                VBuffer.SetData(new VertexPositionNormalTexture[] {
